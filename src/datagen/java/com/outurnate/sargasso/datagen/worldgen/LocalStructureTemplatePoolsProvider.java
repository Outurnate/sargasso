...
public class LocalStructureTemplatePoolsProvider extends StructureProvider {
    ...
    public static final ResourceKey<StructureTemplatePool> VILLAGE_ENTRY = ResourceKey
    ...
    protected void provide(TemplatePoolBuilder bootstrap) {
        ...
        bootstrap.register(
            ...
            entry("village/building_market_2", LocalStructureProcessorListProvider.WOOLS.size()),
            entry("village/building_market_3", LocalStructureProcessorListProvider.WOOLS),
        ...
        bootstrap.register(
            ...
            entry("village/building_arena", LocalStructureProcessorListProvider.BONE_SAND),
            entry("village/building_home_small"));
        bootstrap.register(
            VILLAGE_BUILDINGS_C,
        ...
        bootstrap.register(VILLAGE_LIBRARY_TERMINATORS, "village/building_library_floor");
        bootstrap.register(
            VILLAGE_LIBRARY,
            VILLAGE_LIBRARY_TERMINATORS,
            entry("village/building_library_floor"),
            entry("village/building_library_roof", 3));
        bootstrap.register(VILLAGE_ENTRY, "village/entry");
        bootstrap.register(
            STARTING_HOUSE,
