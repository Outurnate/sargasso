...
public class SpiderBottleItem extends Item implements ProjectileItem {
	public SpiderBottleItem(Item.Properties properties) {
		super(properties);
	}
	...
	public @NonNull Projectile asProjectile(@NonNull Level level, Position position, @NonNull ItemStack itemStack, @NonNull Direction direction) {
		return new ThrownBottleOfSpiders(level, position.x(), position.y(), position.z(), itemStack);
	}
