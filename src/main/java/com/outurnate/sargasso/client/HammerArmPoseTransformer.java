...
public class HammerArmPoseTransformer implements IArmPoseTransformer {
    ...
    private static final Animation MAIN_HAND_ANIM = new Animation(
        new Animation.Keyframe(0.0F, new Vec3(Math.PI * -0.75, Math.PI * -0.05, 0.0)),
        new Animation.Keyframe(0.1F, new Vec3(Math.PI * -0.25, Math.PI * -0.05, 0.0)),
        new Animation.Keyframe(1.0F, new Vec3(Math.PI * -0.75, Math.PI * -0.05, 0.0)));

    private static final Animation OFF_HAND_ANIM = new Animation(
        new Animation.Keyframe(0.0F, new Vec3(Math.PI * -0.75, Math.PI * 0.2, 0.0)),
        new Animation.Keyframe(0.1F, new Vec3(Math.PI * -0.25, Math.PI * 0.2, 0.0)),
        new Animation.Keyframe(0.9F, new Vec3(Math.PI * -0.75, Math.PI * 0.2, 0.0)));
